    ...
    <div className="payslip-copy bg-white p-8 space-y-6">
      ...
      <div className="grid grid-cols-2 gap-10 pt-6 text-xs">
        <div>
          ...
          <p className="mt-4">Date: __________________</p>
        </div>
        <div>
...
export default function Home() {
  ...
  const handleSavePayroll = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/data', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ action: 'payroll', record: { ...newRecord, employeeUid: emp?.uid } })
      });
      const result = await response.json();
      if (!response.ok) throw new Error(result.message);
  ...
  const filteredRecords = currentUser?.role === 'employee' ? payrollRecords.filter(p => p.employee_id === currentUser.id) : payrollRecords;
    ...
    return (
      <div className="w-screen h-screen flex bg-[#04231b] overflow-hidden">
        ...
        <div className="flex-[1.2] relative bg-[url('/mit-school.jpg')] bg-cover bg-center p-14 flex flex-col justify-between text-white">
          <div className="absolute inset-0 bg-gradient-to-br from-[#0a372b]/95 to-[#04231b]/98 z-10" />
          <div className="relative z-20 h-full flex flex-col justify-between">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <div className="max-w-xl">
                ...
                <p className="text-xs text-[#a3d9cb] uppercase tracking-widest font-semibold leading-relaxed mt-2">Web-Based Employee Payroll Management System</p>
              </div>
            </div>
              ...
              {authMode === 'login' ? (
                ...
                >
                  <div className="mb-8">
                    ...
                    <p className="text-sm text-emerald-800/70 mt-1">Enter your institutional credentials to access your dashboard</p>
                  </div>
          ...
          <div className="bg-[#0a372b] p-4 rounded-2xl border border-white/5 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 overflow-hidden">
              {currentUser.role === 'admin' ? (
                ...
                <Image src={currentUser.profile_pic || 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=150'} alt="User" width={36} height={36} className="rounded-full object-cover border border-[#2baf9a] shrink-0" referrerPolicy="no-referrer" />
              )}
              ...
              >
                <div className="flex items-center justify-between flex-wrap gap-4 border-b border-[#e2efe9] pb-5">
                  <div>
                    ...
                    <p className="text-xs text-[#2baf9a] font-medium mt-0.5">Manage active institutional personnel, positions, and salary rates</p>
                  </div>
                    ...
                    <div className="grid grid-cols-3 gap-5">
                      <div>
                        ...
                        <input
                          ...
                          value={payrollForm.late_minutes}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          step="0.01"
                          className="w-full p-3 text-sm border border-red-200 rounded-xl bg-white"
                          value={payrollForm.cash_advances}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          step="0.01"
                          className="w-full p-3 text-sm border border-red-200 rounded-xl bg-white"
                          value={payrollForm.loan_pagibig}
        ...
        {selectedPayslip && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 overflow-y-auto">
            ...
            >
              ...
              <div className="payslip-print-area bg-white">
                <PayslipCopy record={selectedPayslip} />
                <PayslipCopy record={selectedPayslip} />
              </div>
              ...
              <div className="p-4 bg-[#f5fbf9] border-t border-[#e2efe9] flex justify-end gap-3 no-print">
                ...
                >
                  <Printer className="w-4 h-4 text-[#f1c40f]" />
                  <span>Print Electronic Payslip</span>
                </motion.button>
                <button
                  onClick={() => setSelectedPayslip(null)}
